        ...
        messages=[
            {"role": "system",
             "content": "You are given a cv, please check for the misspellings or wrong words replace it with the "
                        ...
                        "and a seperate node with only blankfactor gmail as gmail, don't send anything else that, "
                        "is not specified"
                        "Also the gmail field in the json should always be called gmail. Also make sure that if there "
                        "are two"
                        "emails,"
                        "also get the Blankfactor one, it's at the end and it end with @blankfactor.com. And at the "
                        "and extract S3URL as S3URL."
             },
